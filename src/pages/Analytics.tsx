...
const Analytics = () => {
  ...
  const displayStats = globalStats || mockGlobalStats
                  ...
                  <div key={day.date} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="text-right">
                      <div className="font-semibold text-gray-900 dark:text-white">
                        ₹{day.totalFunded.toLocaleString('en-IN')}
                      </div>
                  ...
                  <div key={country.country} className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-gray-900 dark:text-white">
                          ₹{country.totalFunds.toLocaleString('en-IN')}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="text-right">
                    {selectedType === 'donors' ? (
                      <>
                        <div className="font-semibold text-gray-900 dark:text-white">
                          ₹{(item as any).totalDonated?.toLocaleString('en-IN')}
                        </div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <>
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-400">
                          ₹{(item as any).fundsRaised?.toLocaleString('en-IN')} raised
                        </div>
                      </>
                    )}
                  </div>
