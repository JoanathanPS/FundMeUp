              ...
              {isDemo && mockDonors.length > 0 ? (
                ...
                <div className="card text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    {isDemo ? 'Demo mode: Sample data available' : 'Live mode: No donor data available. Start donating to see leaderboard!'}
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-4">
              {isDemo && mockStudents.length > 0 ? (
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-3">
                        <div>
                          <div className="text-2xl font-bold text-green-600">
                            ₹{(student.totalFunded || 0).toLocaleString()}
                          </div>
                ...
                <div className="card text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    {isDemo ? 'Demo mode: Sample data available' : 'Live mode: No student data available. Students can apply to see leaderboard!'}
                  </p>
                </div>
              )}
            </div>
        ...
        >
          <div className="card text-center">
            ...
            <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
              {isDemo ? (activeTab === 'donors' ? mockDonors.length : mockStudents.length) : 0}
            </div>
          ...
          <div className="card text-center">
            <span className="text-green-500 font-bold text-4xl mx-auto mb-4 block">₹</span>
            <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
              ₹{isDemo 
                ? (activeTab === 'donors' 
                  ? (mockDonors.reduce((sum, d) => sum + (d.totalDonated || 0), 0) || 0).toLocaleString()
          ...
          <div className="card text-center">
            ...
            <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
              {activeTab === 'donors' 
                ? (isDemo 
                  ? (mockDonors.reduce((sum, d) => sum + (d.studentsSupported || 0), 0) || 0)
                  : 0)
                : (isDemo 
                  ? (mockStudents.reduce((sum, s) => sum + (s.milestonesCompleted || 0), 0) || 0)
                  : 0)
              }
            </div>
            <div className="text-gray-600 dark:text-gray-300">
